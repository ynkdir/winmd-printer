...
class JsTypeDefinition
{
    ...
    public IEnumerable<JsCustomAttribute> CustomAttributes
    {
        get =>
    ...
    public IEnumerable<JsFieldDefinition> Fields
    {
        get =>
    ...
    public IEnumerable<JsInterfaceImplementation> InterfaceImplementations
    {
        get =>
    ...
    public IEnumerable<JsMethodDefinition> Methods
    {
        get =>
    ...
    public IEnumerable<JsTypeDefinition> NestedTypes
    {
        get =>
    ...
    public IEnumerable<JsGenericParameter> GenericParameters
    {
        get =>
    ...
    public IEnumerable<JsEventDefinition> Events
    {
        get =>
    ...
    public IEnumerable<JsPropertyDefinition> Properties
    {
        get =>
...
class JsGenericParameter
{
    ...
    public IEnumerable<JsGenericParameterConstraint> Constraints
    {
        get =>
...
class JsCustomAttribute
{
    ...
    public IEnumerable<JsCustomAttributeFixedArgument> FixedArguments
    {
        get =>
    ...
    public IEnumerable<JsCustomAttributeNamedArgument> NamedArguments
    {
        get =>
...
class JsFieldDefinition
{
    ...
    public JsConstant? DefaultValue
    {
        get =>
...
class JsMethodDefinition
{
    ...
    public IEnumerable<string> ImplAttributes
    {
        get
        {
    ...
    public IEnumerable<JsParameter> Parameters
    {
        get =>
